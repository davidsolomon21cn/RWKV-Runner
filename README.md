...
- Can also be used as an OpenAI ChatGPT, GPT-Playground, Ollama, [llmman](https://github.com/llmmanorg/llmman) and more
  clients. (Fill in the API URL and API Key in Settings page)
